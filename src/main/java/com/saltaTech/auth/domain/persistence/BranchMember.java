...
/**
 * Entidad que representa a un miembro dentro de una Sucursal.
 * Implementa la interfaz {@link MemberDetails} para usarse en el sistema de seguridad.
 * Cada miembro está asociado a un {@link User}, una {@link Branch} y un {@link Role}.
 * La clase provee los detalles necesarios para la autenticación y autorización,
 * incluyendo los permisos que otorga el rol dentro de una Sucursal.
...
@AllArgsConstructor
@Builder
@Table(name = "branches_members")
public class BranchMember implements MemberDetails {
	@Id
	...
	public String getRoleName (){
		return role.getName().toUpperCase() + "_" +
				formatOrganizationName(branch.getName());
	}
}
